...
// In development: VITE_API_URL should be empty so Vite's proxy handles /api/*
// In production: set VITE_API_URL=https://api.yourdomain.com in .env
// ─────────────────────────────────────────────────────────────────────────────
...
export const authAPI = {
    ...
    logout: (refresh) => request("POST", "/api/logout/", { refresh }),
