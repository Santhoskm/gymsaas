...
export default function ClientForm({
  ...
  // When the user selects a package, set expiryDate = joinDate + duration_months.
  // This only fires in 'add' and 'upgrade' mode — in renew mode the user is
  // explicitly picking a new expiry so we leave it alone unless they change the pkg.
  useEffect(() => {
    ...
    const newExpiry = addMonths(form.joinDate, selectedPkg.duration_months);
